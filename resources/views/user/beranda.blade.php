        ...
        <div class="w-full max-w-sm bg-white border border-gray-200 rounded-xl shadow dark:bg-white dark:border-gray-700">
            ...
            <div class="px-5 pb-5">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ro}}" class="text-gray-100 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Tambahkan Keranjang</a>
                </div>
            </div>
        </div>
        @endforeach
